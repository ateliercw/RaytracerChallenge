...
class TestMatrices: XCTestCase {
    ...
    func testMatrix() {
        let m = Matrix([[1, 2, 3, 4],
                        ...
                        [9, 10, 11, 12],
                        [13.5, 14.5, 15.5, 16.5]])
        XCTAssertEqual(m[row: 0, col: 0], 1, accuracy: .epsilon)
        XCTAssertEqual(m[row: 0, col: 3], 4, accuracy: .epsilon)
        XCTAssertEqual(m[row: 1, col: 0], 5.5, accuracy: .epsilon)
        XCTAssertEqual(m[row: 1, col: 2], 7.5, accuracy: .epsilon)
        XCTAssertEqual(m[row: 2, col: 2], 11, accuracy: .epsilon)
        XCTAssertEqual(m[row: 3, col: 0], 13.5, accuracy: .epsilon)
        XCTAssertEqual(m[row: 3, col: 2], 15.5, accuracy: .epsilon)
    }
    ...
    func testTwoByTwoMatrix() {
        let m = Matrix([[-3, 5],
                        [1, -2]])
        XCTAssertEqual(m[row: 0, col: 0], -3, accuracy: .epsilon)
        XCTAssertEqual(m[row: 0, col: 1], 5, accuracy: .epsilon)
        XCTAssertEqual(m[row: 1, col: 0], 1, accuracy: .epsilon)
        XCTAssertEqual(m[row: 1, col: 1], -2, accuracy: .epsilon)
    }
    ...
    func testThreeByThreeMatrix() {
        ...
        XCTAssertEqual(m[row: 0, col: 0], -3, accuracy: .epsilon)
        XCTAssertEqual(m[row: 1, col: 1], -2, accuracy: .epsilon)
        XCTAssertEqual(m[row: 2, col: 2], 1, accuracy: .epsilon)
    }
